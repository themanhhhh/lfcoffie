...
export class DSMonTrongComboController {
  private repository = AppDataSource.getRepository(DSMonTrongCombo);
  ...
  async create(req: Request, res: Response) {
    try {
      const obj = this.repository.create(req.body as DSMonTrongCombo);
