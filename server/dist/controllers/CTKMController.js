...
class CTKMController {
    constructor() {
        ...
        this.giamHoaDonRepo = data_source_1.AppDataSource.getRepository(GiamHoaDon_1.GiamHoaDon);
        this.giamMonRepo = data_source_1.AppDataSource.getRepository(GiamMon_1.GiamMon);
        this.comboRepo = data_source_1.AppDataSource.getRepository(Combo_1.Combo);
        this.dsMonTrongComboRepo = data_source_1.AppDataSource.getRepository(DSMonTrongCombo_1.DSMonTrongCombo);
    }
