...
exports.CreateThuChiTable1764568155047 = void 0;
class CreateThuChiTable1764568155047 {
    async up(queryRunner) {
        ...
        if (!table) {
            ...
            const hasPhienLamViecFK = foreignKeys.some(fk => fk.columnNames.includes("MaPhienLamViec"));
            const hasNghiepVuFK = foreignKeys.some(fk => fk.columnNames.includes("MaNghiepVu"));
...
exports.CreateThuChiTable1764568155047 = CreateThuChiTable1764568155047;
